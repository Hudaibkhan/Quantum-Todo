...
const SignupForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use the register function from AuthContext - send email, username, and password
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        {/* Animated Orbs */}
        <div className="absolute top-0 -left-4 w-72 h-72 bg-purple-300 dark:bg-purple-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-70 animate-blob"></div>
        <div className="absolute top-0 -right-4 w-72 h-72 bg-indigo-300 dark:bg-indigo-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-blue-300 dark:bg-blue-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-fade-in-up animation-delay-200">
          <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border-2 border-slate-200 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-700 transition-all duration-300">
              ...
              <div className="space-y-5">
                ...
                <div className="animate-fade-in animation-delay-600">
                  ...
                  {confirmPasswordError && (
                    <p className="mt-1 text-sm text-red-600 dark:text-red-400 animate-shake">{confirmPasswordError}</p>
                  )}
                </div>
              </div>
            ...
            <div className="mt-6 animate-fade-in animation-delay-800">
              ...
              <div className="mt-6">
                ...
                >
                  <svg className="w-5 h-5 mr-2 group-hover:rotate-[-15deg] transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-6 flex justify-center animate-fade-in animation-delay-900">
            <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700">
              ...
              <span className="font-medium">Your data is secured with encryption</span>
            </div>
          </div>
        </div>
      </div>
